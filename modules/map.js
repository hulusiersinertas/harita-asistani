...
const MapManager = {
    ...
    renderHarita: function(gorevListesi) {
        ...
        // Akıllı temizlik: Kullanıcı pini ve rotayı koru, diğer her şeyi sil
        ...
        gorevListesi.forEach(gorev => {
            if (gorev.enlem && gorev.boylam) {
                const placemark = new ymaps.Placemark([gorev.enlem, gorev.boylam], {
                    ...
                    preset: 'islands#redDotIcon' // Aktif pin stili
                });
    ...
    filtrele: function(secilenMahalle) {
        ...
        AppState.tumPlacemarks.forEach(placemark => {
            ...
            if (secilenMahalle === 'TUMU' || pinMahalle === secilenMahalle) {
                placemark.options.set('preset', 'islands#redDotIcon'); // Aktif renk
                ...
                placemark.options.set('preset', 'islands#yellowDotIcon'); // Pasif renk
    ...
    vurgulaPin: function(secilenPlacemark) {
        ...
        secilenPlacemark.options.set('preset', 'islands#greenIcon'); // Vurgu rengi
