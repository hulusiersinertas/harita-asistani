...
const MapManager = {
    ...
    initMap: async function(elementId) {
        try {
            ...
            // Döndürme kontrollerini içeren UI modülünü import ediyoruz.
            ...
            // Haritaya Döndürme Kontrolü'nü (Pusula butonu) ekliyoruz.
            ...
            // Hatanın yukarıya da iletilmesini sağlıyoruz ki uygulama dursun.
            throw error;
        }
    },
