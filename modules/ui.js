...
const UI = {
    ...
    renderDetayPaneli: function(rowIndex) {
        ...
        // =========================================================================
        // ==== DEĞİŞİKLİK BURADA: "Rota Çiz" butonu eklendi ====
        // =========================================================================
        let aksiyonButonlari = `<button class="buton nav-buton" disabled>Konum Yok</button>`;
        ...
        this.elements.gorevDetay.innerHTML = `
            ...
            <div class="buton-grup">${aksiyonButonlari}</div>
            <div class="buton-grup">
                ...
                <button class="buton diger-buton" onclick="UI.updateGorev(${gorev.rowIndex}, 'Adres Yanlış', '${adSoyadEscaped}')">Adres Yanlış</button>
            </div>`;
    },
