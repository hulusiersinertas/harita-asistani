...
const UI = {
    elements: { body: document.body, aracBaslik: document.getElementById('arac-baslik'), gorevSayaci: document.getElementById('gorev-sayaci'), mahalleFiltre: document.getElementById('mahalle-filtre'), gorunumBtn: document.getElementById('gorunum-degistir-btn'), mapElement: document.getElementById('map'), gorevListesiTam: document.getElementById('gorev-listesi-tam'), gorevDetay: document.getElementById('gorev-detay') },
    ...
    renderDetayPaneli: function(rowIndex) {
        ...
        if (gorev.enlem && gorev.boylam) { navButon = `<a href="https://yandex.com.tr/harita/?rtext=~${gorev.enlem},${gorev.boylam}" target="_blank" class="buton nav-buton">Navigasyon</a><button class="buton" style="background-color: #7b1fa2;" onclick="UI.handleDrawRoute(${gorev.rowIndex})">Rota Çiz</button>`; }
